...
type ConfirmationModalProps = {
  ...
  successAction: (_address: string, _amount: string) => void;
  processing?: boolean;
};
    ...
    >
      <Modal.Header>
        <div className="flex flex-row items-center gap-2">
          ...
          <h1 className="text-lg font-semibold">Request Withdrawal</h1>
        </div>
      </Modal.Header>
      <Modal.Body>
        {<div className="text-center flex flex-col gap-3 text-black">
          <div className="flex flex-col gap-1 items-start">
            <p className="text-sm font-semibold">Enter address</p>
          ...
          <Button
            ...
            onClick={() => {
              if (amount !== "0" && address !== "") {
                successAction(address, amount);
              }
            }}
            // processingLabel="Processing"
          >
            {processing ? "Requesting withdrawal..." : "Confirm"}
          </Button>
          <p
